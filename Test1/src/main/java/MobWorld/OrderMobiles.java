...
public class OrderMobiles extends Home {
	...
	driver.findElement(By.id("inputFirstName")).sendKeys("Nitesh");
	driver.findElement(By.xpath("(//*[@id='inputFirstName'])[2]")).sendKeys("L");
	driver.findElement(By.id("inputEmail")).sendKeys("Nithu@gmail.com");
	driver.findElement(By.id("inputPassword")).sendKeys("Nl@123");
	driver.findElement(By.id("flexRadioDefault2")).click();
	driver.findElement(By.xpath("//*[@placeholder='00000000000']")).sendKeys("123456");
	driver.findElement(By.id(" address1")).sendKeys("#67,10th main,3rd stage,W.O.C road");
	driver.findElement(By.id("address2")).sendKeys("Manjunathnagar");
